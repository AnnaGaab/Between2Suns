...
%   TikZ/PGF Settings fuer die Karten
...
%   Stylings fuer die Elemente definieren
\tikzset{
    %   runde Ecken fuer die Karten
    cardcorners/.style={
        rounded corners=0.2cm
    },
    %   runde Ecken fuer die "Faehnchen"
    elementcorners/.style={
        rounded corners=0.1cm
    },
    %   Schlagschatten fuer die "Faehnchen"
    stripshadow/.style={
        drop shadow = {opacity=0.5}
    },
    %   Style fuer die "Faehnchen"
    strip/.style={
        elementcorners,
        stripshadow
    },
    %   Bild fuer das Kartenmotiv
    cardimage/.style={
        path picture={
...
\newcommand{\cardtypeDamage}{\cardtype{damagebg}{Damage}{\hspace{-1mm}\LARGE\danger}}
\newcommand{\cardtypeCritical}{\cardtype{criticaldamagebg}{Critical Damage}{\hspace{-1mm}\Large\bomb}}
\newcommand{\cardtypeMission}{\cardtype{missionbg}{Mission}{\hspace{-1mm}\LARGE\decosix}}
\newcommand{\cardtypeCrew}{\cardtype{testbg}{Crew Effect}{\hspace{-1.4mm}\LARGE\grimace}}
...
\newcommand{\cardcontent}[2]{
    ...
    \node[below right, text width=(\cardwidth-2*\strippadding-\stripwidth-2*\textpadding-0.3)*1cm] at (2*\strippadding+\stripwidth+\textpadding,3) {
    	% Trennstrich
        \vrule width \textwidth height 1pt \\[-2pt]
        % Abstand Trennstrich zu Text unten
        \vspace{0.2cm}
        {\scriptsize #2}
    };
}
